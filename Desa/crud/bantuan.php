...
<html lang="en">
  ...
  <div class="container" style="margin-top:20px">
    <div class="col-lg-12 text-center mb-5" style="margin-top: 10%;">
		<h1>DATA PENERIMA BANTUAN BLT</h1>
    </div>
    <a href="tambah_bantuan.php" class="btn tambah">Tambah Data</a>
    ...
    <table class="table table-striped" style="text-align: center; margin-top:20px;">
     ...
     <!-- menampilkan data -->
        ...
        <?php
            ...
            if( isset($_POST["cari"]) ) {
              $data = mysqli_query($koneksi, "SELECT * FROM bantuan where no_kk LIKE '%".$_POST['keyword']."%' or nama LIKE '%".$_POST['keyword']."%'");
            } 
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_bantuan.php ?no_kk=<?php echo $d['no_kk'];?>" class="btn btn-secondary btn-sm">Edit</a>
                    <a href="hapus_bantuan.php ?no_kk=<?php echo $d['no_kk'];?>" class="btn btn-danger btn-sm">Hapus</a>
                </td>
            </tr>
            <?php
                } } else {
