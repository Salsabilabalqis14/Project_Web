...
<!-- edit data penduduk -->
    ...
    <?php
        ...
        $no_ktp = $_GET['no_ktp'];
        $show = mysqli_query($koneksi,"SELECT * FROM data_pengurus where no_ktp = '$no_ktp'");
...
<div class="container" style="margin-top:20px">
    ...
    <div class="position-absolute top-50 start-50 translate-middle ">
        <form action="edit_proses_png.php" method="POST" enctype="multipart/form-data">
            ...
            <table class="tabel">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="text" name="jabatan" value="<?php echo $d['jabatan']; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>No Telepon</td>
