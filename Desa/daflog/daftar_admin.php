...
<div class="container" style="margin-top:20px">
    <div class="col-lg-12 text-center mb-5" style="margin-top: 2%;">
		<h1>Registrasi Pengurus Desa</h1>
    ...
    <div class="row">
        <div class="col-md-6" >
            <img src="1.png" alt="" width="550px" height="500px">
        </div>
        <div class="col-md-6">
            <form action="daftar_admin_proses.php" method="POST">
                <table class="tabel" style="margin-top : 60px;">
                    <tr>
                        <td>Username</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Sandi</td>
                        <td>:</td>
                        <td><input type="text" name="sandi" placeholder="Sandi" required></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>:</td>
    ...
    <div class="container">
        <div class="row">
            <ul>
                <li><a href="daftar.php">Daftar sebagai Penduduk Desa? Klik di sini ya.</a></li>
                <li><a href="login_admin.php">Masuk sebagai Pengurus Desa? Klik di sini ya.</a></li>
            </ul>
        </div>
    </div>
